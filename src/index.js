...
var base = Rebase.createClass({
  apiKey: "AIzaSyCCEl6Aab4YG2MCmClIhLFd5tmzK_ZLnkU",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix-a12d4.firebaseio.com", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  viewChanged: function(view) {
    ...
    if (view == "alpha") {
      var view = movieData.sort(this.movieCompareByTitle)
    } else if (view=="latest") {
      var view = movieData.sort(this.movieCompareByReleased)
    }
    this.setState({
      currentView: view
    })
